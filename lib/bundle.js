...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let introExiter = Array.prototype.slice.call(document.getElementsByClassName('intro-exiter'));
  let introItems = Array.prototype.slice.call(document.getElementsByClassName('intro'));
  introExiter.forEach( (exiter) => {
